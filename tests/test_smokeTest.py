...
class TestSmokeTest():
  ...
  def test_adminPage(self):
    self.driver.get("https://cherry-machado.github.io/cse270-teton/admin.html")
    self.driver.set_window_size(1280, 800)
  ...
  def test_directoryPage(self):
    self.driver.get("https://cherry-machado.github.io/cse270-teton/directory.html")
    self.driver.set_window_size(1280, 800)
  ...
  def test_homePage(self):
    self.driver.get("https://cherry-machado.github.io/cse270-teton/")
    self.driver.set_window_size(1280, 800)
  ...
  def test_joinPage(self):
    self.driver.get("https://cherry-machado.github.io/cse270-teton/join.html")
    self.driver.set_window_size(1280, 800)
    elements = self.driver.find_elements(By.NAME, "fname")
    assert len(elements) > 0
    self.driver.find_element(By.NAME, "fname").click()
    self.driver.find_element(By.NAME, "fname").send_keys("Cherry")
    self.driver.find_element(By.NAME, "lname").click()
    self.driver.find_element(By.NAME, "lname").send_keys("Machado")
    self.driver.find_element(By.NAME, "bizname").click()
    self.driver.find_element(By.NAME, "bizname").send_keys("Minegocio")
    self.driver.find_element(By.NAME, "biztitle").click()
    self.driver.find_element(By.NAME, "biztitle").send_keys("Supervisor")
